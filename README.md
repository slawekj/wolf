...
This project uses the following modules:
  ...
  1. Data.provider is responsible for a real-time Forex feed to the system. To have that data free of charge it uses data aggregated by [HistData.com](histdata.com) every month. The data feed is therefore one month old, e.g., a tick that happened in June at exactly '2014-06-03 15:32:21.451 EST' is fed to the system on July at exactly '2014-07-03 15:32:21.451 EST'. This approach helps generating traffic at no cost similar to what expensive data providers would provide.
